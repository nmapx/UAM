...
Zaimplementuj funkcję `get_artists(prefs, rating, min_users=1)`,
która zwraca listę rekomendowanych artystów.
Należy brać pod uwagę tylko tych artystów, którzy
...
import unittest
from TaskD05 import get_artists

class TaskD05Test(unittest.TestCase):
    ...
    def test_complicated(self):
        ...
        test3 = ['Red Hot Chili Peppers',
                 'Rage Against the Machine',
                 'Yellowcard']
        sorted(test3)
        movies = get_artists(prefs, my_ratings, 2)
        sorted(movies)
        print movies

        self.assertEqual(test3, movies)
