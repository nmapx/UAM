...
Zaimplementuj funkcję `sim_distance(ratings1, ratings2)`, która oblicza
podobieństwo między dwoma użytkownikami na podstawie odległości
euklidesowej ich preferencji. Jeżeli `d` to odległość to podobieństwo
liczymy jako `1/(1+d)`. W słownikach mamy tylko informacje o artystach,
których utwory zostały przez danego użytkownika odtwarzane. W
przypadku brakującego artysty należy przyjąć, że dane użytkownik nie
odtwarzał jego utworów.
...
import unittest
from TaskD02 import sim_distance

class TaskD02Test(unittest.TestCase):
    """Testy do zadania TaskD02."""
    ...
    def test_complicated(self):
        ...
        for ratings1, ratings2, dist in test:
            self.assertAlmostEqual(
                sim_distance(ratings1, ratings2), dist, 4)
