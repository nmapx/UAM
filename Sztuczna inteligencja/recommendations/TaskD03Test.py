...
Zaimplementuj funkcję `sim_pearson(ratings1, ratings2)`, która oblicza
podobieństwo między dwoma użytkownikami na podstawie współczynnika
korelacji Pearsona r ich preferencji. Zwracamy 0, jeżeli r < 0. W
słownikach mamy tylko informacje o artystach, których utwory zostały
przez danego użytkownika odtwarzane. W przypadku brakującego artysty
należy przyjąć, że dane użytkownik nie odtwarzał jego utworów. Jako
`m` należy we wzorze korelacji Pearsona przyjąć liczbę `sys.maxsize`
(zamiast długości wektora).
...
class TaskD03Test(unittest.TestCase):
    """Testy do zadania TaskD03."""
    ...
    def test_complicated(self):
        ...
        user2 = {'Lenny Kravitz': 0.029534606205250596,
        ...
        user3 = {'Daft Punk': 0.29723991507430997,
        ...
        for ratings1, ratings2, dist in test:
            self.assertAlmostEqual(
                sim_pearson(ratings1, ratings2), dist, 4)
